...
short link and deleted after the fact. See the [demo report](https://selbstbild.eu/demo) (`/demo` route in the app).
...
That being said, it wasn't perfect and I doubt coding has truly "been solved" if A.) potential issues sneak in for a code base this straight forward and overrepresented in the training data and secondly, someone like myself can find said issues. LLMs are an amazing tool and Fable 5 is very helpful for development, but with "quality escapements" finding their way into a project this simple, I personally am far from being able to in good conciouns "not look at the code": https://github.com/Topfi/selbstbild/blob/11942a390bd3a5f52be40bd6e21bb0a2e77c556e/src/lib/providers/anthropic.ts
